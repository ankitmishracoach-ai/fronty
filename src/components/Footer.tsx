        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/features/inbox" className="text-slate-600 hover:text-slate-900 transition-colors text-sm">
                  Inbox
                </Link>
              </li>
              <li>
                <Link to="/features/ai" className="text-slate-600 hover:text-slate-900 transition-colors text-sm">
                  AI Assistant
                </Link>
              </li>
              <li>
                <Link to="/features/tickets" className="text-slate-600 hover:text-slate-900 transition-colors text-sm">
                  Tickets
                </Link>
              </li>
              <li>
                <Link to="/features/automation" className="text-slate-600 hover:text-slate-900 transition-colors text-sm">
                  Automation
                </Link>
              </li>
              <li>
                <Link to="/features/analytics" className="text-slate-600 hover:text-slate-900 transition-colors text-sm">
                  Analytics
                </Link>
              </li>
              <li>
                <Link to="/features/channels" className="text-slate-600 hover:text-slate-900 transition-colors text-sm">
                  Channels
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/use-cases" className="text-slate-600 hover:text-slate-900 transition-colors text-sm">
                  Use Cases
                </Link>
              </li>
              <li>
